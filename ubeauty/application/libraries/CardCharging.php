    ...
    function   CardCharging_()
    {
        ...
        if ($this->SessionID == null || $this->SessionID == "") {
            ...
            if ($loginresponse->m_Status == "1") {
                ...
                $this->session->set_userdata('loginsession', $this->SessionID);
                ...
                //echo"<br/>----Login fail-----------<br/>";
                $Ojb->m_Status = $loginresponse->m_Status;
                $Ojb->m_Message = $loginresponse->m_Sessage;
                $Ojb->m_TRANSID = $loginresponse->m_TransID;
                $Ojb->m_AMOUNT = 0;
                $Ojb->m_RESPONSEAMOUNT = 0;
                return $Ojb;
            }
        }
...
Class login
{
    ...
    function  login_()
    {
        ...
        $RSAClass->GetpublicKeyFrompemFile(getcwd() . "/application/libraries/VNPT/Epay_Public_key.pem");
        try {
        ...
        $RSAClass->GetPrivatekeyFrompemFile(getcwd() . "/application/libraries/VNPT/partner_private_key.pem");
        try {
