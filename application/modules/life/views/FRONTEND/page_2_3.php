...
<div class="body_bg">
    ...
    <div class="place">■ 您当前的位置：<a href="<?php base_url() ?>/">首页</a>&nbsp;>&nbsp;<a
            href="<?php base_url() ?>/bizhengxingwenda/">鼻整形问答</a></div>
    <div class="article">
        <!-- zj_left -->
        <div class="fleft">
            <div class="viewbox">
        ...
        <div class="fright">
            ...
            <div class="tit4">推荐做假体隆鼻手术专家</div>
            <ul class="doctor_tj">
                <li><a href="<?php base_url() ?>/zj/yuanqiang.html" target="_blank"><img src="<?=STATIC_PATH_URL ?>assets/images/docngy.png"></a>
                </li>
